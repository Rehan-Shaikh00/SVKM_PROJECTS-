...
EN = {
    ...
    "followup_offer": "That is a long answer. Should I send the details to you by SMS or email instead?",
...
HI = {
    ...
    "followup_offer": "यह जानकारी लंबी है। क्या मैं इसे एसएमएस या ईमेल से भेज दूँ?",
...
RAJ = {
    ...
    "followup_offer": "ई जाणकारी लम्बी है। म्हूँ ई एसएमएस या ईमेल सूं भेज दूँ?",
...
MR = {
    ...
    "followup_offer": "ही माहिती लांब आहे. ती मी तुम्हाला एसएमएस किंवा ईमेलने पाठवू का?",
